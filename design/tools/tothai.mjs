...
const THAI = {
  ...
  'Quiet &middot; long decay &middot; 8s loop': 'เบา &middot; ค่อยๆ จางหาย &middot; วน 8 วินาที',
  ...
  'Long decay &middot; used by 1 alarm': 'ค่อยๆ จางหาย &middot; ใช้กับนาฬิกาปลุก 1 รายการ',
  ...
  'Sonar': 'โซนาร์',
  'Beeps': 'เสียงบี๊บ',
  'Gentle &middot; swells slowly': 'นุ่มนวล &middot; ค่อยๆ ดังขึ้น',
  'Soft &middot; a little tune': 'เบา &middot; ทำนองสั้นๆ',
  'Light &middot; chirping': 'สดใส &middot; นกร้องจิ๊บๆ',
  'Bright &middot; ringing': 'ใส &middot; กังวาน',
  'Clear &middot; steady pings': 'ชัด &middot; ดังเป็นจังหวะ',
  'Classic &middot; hard to sleep through': 'คลาสสิก &middot; ปลุกยังไงก็ตื่น',
  'Gentle &middot; not used yet': 'นุ่มนวล &middot; ยังไม่ได้ใช้',
  'Soft &middot; not used yet': 'เบา &middot; ยังไม่ได้ใช้',
  'Light &middot; not used yet': 'สดใส &middot; ยังไม่ได้ใช้',
  'Bright &middot; not used yet': 'ใส &middot; ยังไม่ได้ใช้',
  'Clear &middot; not used yet': 'ชัด &middot; ยังไม่ได้ใช้',
  'Classic &middot; not used yet': 'คลาสสิก &middot; ยังไม่ได้ใช้',
  ...
  'Test real alarm at 85%': 'ทดลองปลุกจริงที่ 85%',
  'Test real alarm at 50%': 'ทดลองปลุกจริงที่ 50%',
  'Vibrate': 'สั่น',
  'Vibrates while it rings &middot; on the Lock Screen, your Haptics setting decides':
    'สั่นระหว่างปลุก &middot; บนหน้าจอล็อกจะเป็นไปตามการตั้งค่าการสั่นของเครื่อง',
  'Snooze': 'เลื่อนปลุก',
  ...
  "Siren &middot; at this alarm's volume": 'ไซเรน &middot; ตามระดับเสียงของการปลุกนี้',
  ...
  'Lets alarms ring at their own volume, even in Silent mode': 'ทำให้นาฬิกาปลุกดังตามระดับที่ตั้งไว้ แม้อยู่ในโหมดเงียบ',
  'Allowed': 'อนุญาตแล้ว',
