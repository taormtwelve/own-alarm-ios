...
enum AppLanguage: String, Codable, CaseIterable, Identifiable, Sendable {
    ...
    static let thaiLines: [(String, String)] = [
        ...
        ("Only this alarm rings at this level — every other alarm keeps its own. 100% is your Ringer & Alerts volume — raise it in Settings › Sounds & Haptics if you want louder.",
         "เฉพาะนาฬิกาปลุกนี้ที่ดังระดับนี้ — นาฬิกาปลุกอื่นมีระดับของตัวเอง 100% คือระดับเสียงเรียกเข้าและการแจ้งเตือนของคุณ — เพิ่มได้ที่ การตั้งค่า › เสียงและการสั่น หากต้องการให้ดังขึ้น"),
        ("Vibrate", "สั่น"),
